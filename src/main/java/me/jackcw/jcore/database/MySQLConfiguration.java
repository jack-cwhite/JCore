...
public final class MySQLConfiguration
{
    ...
    public MySQLConfiguration(String host, int port, String database, String username, String password)
    {
        if (host == null || host.isBlank())
            throw new IllegalArgumentException("Database host cannot be null or blank");

        if (port <= 0 || port > 65535)
            throw new IllegalArgumentException("Data port must be between 1 and 65535");
